  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-white w-full md:w-1/2 ">
        <h1 className="text-2xl md:text-5xl font-bold mt-32 mb-6 text-transparent bg-clip-text bg-[length:200%_100%] bg-gradient-to-r from-yellow-500 to-black animate-fillText">
          Tailored Rides for Corporates, Consulates & Global Travelers
        </h1>

        <p className="text-base sm:text-lg mb-8 px-2 sm:px-0">
          We specialize in providing tailored services to a diverse range of
          clients, including corporate organizations, consulates, and Foreign
